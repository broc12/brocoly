...
public class PaymentCancleController {
	...
	public void paymentCancle(@RequestParam("rent_reserve_no") String rent_reserv_no, @RequestParam("rent_payment_no") String rent_payment_no) {
