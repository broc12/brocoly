...
public class Member {
	...
	public Member(String member_no, String id, String pwd, String name, Date birth, String sex, String sclc,
			...
			String memeber_whithdraw_at, Date whithdraw_date) {
		super();
		...
		this.memeber_whithdraw_at = memeber_whithdraw_at;
	...
	public String getMemeber_local() {
		return memeber_local;
	}
	public void setMemeber_local(String memeber_local) {
		this.memeber_local = memeber_local;
	}
	...
	public String getMemeber_whithdraw_at() {
		return memeber_whithdraw_at;
	}
	public void setMemeber_whithdraw_at(String memeber_whithdraw_at) {
		this.memeber_whithdraw_at = memeber_whithdraw_at;
	}
