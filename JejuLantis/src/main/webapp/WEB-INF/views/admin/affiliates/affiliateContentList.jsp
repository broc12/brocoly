  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">제휴문의관리</li>
      </ol>
      <!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i>제휴문의관리</div>
        <div class="card-body">
        <div class="table-responsive">
        	<c:forEach items="${affiliateContentList}" var="affiliateContentList" varStatus="status">
		    	<table border="0" width="100%"  cellpadding="0" cellspacing="0">
					<tr style="color:#808080;font-size:12pt">			
						<th  height="60px" width="10%" class="text-center" style="background-color: #fafafa">제휴일련번호</th>
						<th  width="35%" class="text-left">
							${affiliateContentList.affiliate_no}
						</th>
						<th  height="60px" width="10%" class="text-center" style="background-color: #fafafa">업체명</th>
						<th  width="35%" class="text-left">
							${affiliateContentList.affiliate_branch_name}
						</th>
					</tr>
					<tr style="color:#808080;font-size:12pt">
						<th  height="60px" width="10%" class="text-center" style="background-color: #fafafa">담당자명</th>
						<th  width="35%" class="text-left">
							${affiliateContentList.affiliate_member_name}
						</th>
						<th  height="60px" width="10%" class="text-center" style="background-color: #fafafa">전화번호</th>
						<th  width="35%" class="text-left">
							${affiliateContentList.affiliate_member_tel}
						</th>
					</tr>
					<tr style="color:#808080;font-size:12pt">			
						<th  height="60px" width="10%" class="text-center" style="background-color: #fafafa">제목</th>
						<th  width="35%" class="text-left">
							${affiliateContentList.affiliate_title}
						</th>
						<th  height="60px" width="10%" class="text-center" style="background-color: #fafafa">내용</th>
						<th  width="35%" class="text-left">
							${affiliateContentList.affiliate_content}
						</th>
					</tr>
					<tr style="color:#808080;font-size:12pt">			
						<th  height="60px" width="10%" class="text-center" style="background-color: #fafafa">등록날짜</th>
						<th  width="35%" class="text-left">
							${affiliateContentList.affiliate_date}
						</th>
					</tr>
					<tr style="font-size:10pt" height="60px">
						<td align="center"></td>
						<td align="right">
							<button type="button" class="btn btn-primary"><a href="affiliateList.do?manager_id=${managerlog.manager_id}" style="color:white">목록</a></button>
						</td>
					</tr>
				</table>
			</c:forEach>
