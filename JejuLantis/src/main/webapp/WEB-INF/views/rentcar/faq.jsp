												...
												<table border="0" width="100%" height="100" style="background-color:#eef2f5">
													...
													<tr>
													 <td height="180px" valign="top">
													 	...
													 	<a style="color:black">제주패스렌트카에서는 전연령 렌트카를 대여하지 않습니다. 만 21세 이상, 면허취득일부터 1년 경과 시 렌트카를 대여할 수 있는 점 참고해 주세요.</a>
													 </td>
													 <td width="5%">
													 </td>
													 <td valign="top">
												...
												<table border="0" width="100%" height="100" style="background-color:#eef2f5">
													...
													<tr>
													 ...
													 <td valign="top">
													 	...
													 	<a style="color:black">제주패스렌트카 홈페이지/APP에서 직접 예약을 취소할 수 있으나, 렌트카 대여시점까지 24시간이 남지 않는 경우, 고객센터(1544-0445)로 문의주셔야 합니다.</a></br></br>
													...
													<tr>
													 ...
													 <td valign="top">
													 	...
													 	<a style="color:black">1단계. 카카오톡 플러스친구(@제주패스렌트카)를 추가해 주세요.</a></br>
